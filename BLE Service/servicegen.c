...
const uint8_t code SCAN_RESPONSE_DATA_INITIAL[32] =
{
#ifdef IAPLAT_BT_CAMERA
#ifdef BT_CUSTOMER_NAME
    0x10,  //User Define Scan response Data Length  BT Shutter-KUN
    0x0F, 0x09, 0x42, 0x54, 0x20, 0x53, 0x68, 0x75,
    0x74, 0x74, 0x65, 0x72, 0x2D, 0x4B, 0x55, 0x4E,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
#else
    0x12,  //User Define Scan response Data Length
    0x0F, 0x09, 0x49, 0x41, 0x50, 0x4C, 0x41, 0x54,
    0x5F, 0x42, 0x54, 0x5F, 0x43, 0x41, 0x4D, 0x45,
...
const uint8_t code ADV_DATA_INITIAL[32] =
{
    ...
    0x02, 0x01, 0x05, 0x03, 0x02, 0xF0, 0xFF, 0x03,
...
const uint8_t code SCAN_RESPONSE_DATA_INITIAL[32] =
{
    14,  //length User Define Scan response Data Length

    13,  // device name + id =length
		0x09, // id
		0x41, 0x4D, 0x49, 0x43, 0x43, 0x4F,
    0x4D, 0x5F, 0x44, 0x65, 0x6D, 0x6F, 
		0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
...
#elif defined _PROFILE_HOGP_
#ifdef IAPLAT_BT_CAMERA
#ifdef BT_CUSTOMER_NAME // BT Shutter-KUN 
        0x0E,
        0x42, 0x54, 0x20, 0x53, 0x68, 0x75, 0x74, 0x74,
        0x65, 0x72, 0x2D, 0x4B, 0x55, 0x4E,
#else
        0x10,
        0x49, 0x41, 0x50, 0x4C, 0x41, 0x54, 0x5F, 0x42,
        0x54, 0x5F, 0x43, 0x41, 0x4D, 0x45, 0x52, 0x41,
#endif
#else
        0x10,
...
const uint8_t code ATT_HDL_OTA_CHARACTERISTIC_OTA_DATA_ERROR_STATUS[] =
{
    0x00, 0x30,
    0x28, 0x03,
    0x05,
...
const uint8_t code ATT_HDL_OTA_DATA_ERROR_STATUS_INIT[] =
{
    0x00, 0x31,
    0xFA, 0x13,
    0x04,
...
uint8_t xdata att_HDL_OTA_DATA_ERROR_STATUS[] =
{
    0x00, 0x00, 0x00, 0x00,
};

const uint8_t code ATT_HDL_OTA_DATA_ERROR_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION_INIT[] =
{
    0x00, 0x32,
    0x29, 0x02,
    0x02,
...
uint8_t xdata att_HDL_OTA_DATA_ERROR_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION[] =
{
    0x00, 0x00
};

const uint8_t code ATT_HDL_OTA_DATA_ERROR_STATUS_USER_DESCRIPTION[] =
{
    0x00, 0x33,
    0x29, 0x01,
    0x11,
    0x44, 0x41, 0x54, 0x41, 0x5F, 0x45, 0x52, 0x52,
    0x4F, 0x52, 0x5F, 0x53, 0x54, 0x41, 0x54, 0x55,
    0x53,
};
...
const uint8_t code ATT_PERMISSION_HDL_OTA_DATA_ERROR_STATUS_INIT[] =
{
    {
        //0x01 |
        //0x02 |
...
const uint8_t code ATT_PERMISSION_HDL_OTA_DATA_ERROR_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION_INIT[] =
{
    {
        0x01 |
        0x02 |
...
const uint8_t code ATT_PERMISSION_HDL_OTA_DATA_ERROR_STATUS_USER_DESCRIPTION[] =
{
    {
        0x01 |
        //0x02 |
...
code uint8_t code *ATTRIBUTE_SERVER[SIZE_ATTRIBUTE_SERVER] =
{
    ...
    ATT_HDL_OTA_CHARACTERISTIC_OTA_DATA_ERROR_STATUS,
    ATT_HDL_OTA_DATA_ERROR_STATUS_INIT,
    ATT_HDL_OTA_DATA_ERROR_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION_INIT,
    ATT_HDL_OTA_DATA_ERROR_STATUS_USER_DESCRIPTION,
...
code uint8_t *ATTRIBUTE_SERVER_param[SIZE_ATTRIBUTE_SERVER] =
{
    ...
    att_HDL_OTA_OTA_CMD_CONTROL_POINT_CLIENT_CHARACTERISTIC_CONFIGURATION,
        ...
        &ATT_HDL_OTA_CHARACTERISTIC_OTA_DATA_ERROR_STATUS[5],
    att_HDL_OTA_DATA_ERROR_STATUS,
    att_HDL_OTA_DATA_ERROR_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION,
        &ATT_HDL_OTA_DATA_ERROR_STATUS_USER_DESCRIPTION[5],
...
code uint8_t code *ATTRIBUTE_SERVER_PERMISSION[SIZE_ATTRIBUTE_SERVER] =
{
    ...
    ATT_PERMISSION_CHARACTERISTIC,
    ATT_PERMISSION_HDL_OTA_DATA_ERROR_STATUS_INIT,
    ATT_PERMISSION_HDL_OTA_DATA_ERROR_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION_INIT,
    ATT_PERMISSION_HDL_OTA_DATA_ERROR_STATUS_USER_DESCRIPTION,
    ATT_PERMISSION_PRIMARY_SERVICE,
    ATT_PERMISSION_CHARACTERISTIC,
