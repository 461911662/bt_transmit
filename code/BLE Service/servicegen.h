...
#define SIZE_ATTRIBUTE_SERVER         (56 + SIZE_ATTRIBUTE_HIDS + SIZE_ATTRIBUTE_TAOBAO + SIZE_ATTRIBUTE_WECHAT + SIZE_ATTRIBUTE_WECHAT_SIMPLE_MODE + SIZE_ATTRIBUTE_USER_DEFINE_01 + SIZE_ATTRIBUTE_GLS)
/*********************************************************************
** Extern Code
*********************************************************************/
...
#ifdef _PROFILE_HOGP_KEYBOARD_
extern uint8_t xdata att_HDL_HIDS_REPORT_KBO[];
