...
typedef struct
{
    ...
    uint8_t MACAddr_Type;              /*!< Specifies the MACAddr_Type.
                                          If MACAddr_Type = PUBLIC, ADV use public mac address format.
                                          If MACAddr_Type = RANDOM, ADV use random mac address format*/
}ADV_InitDef;
/**
* @}
*/
...
extern bit bonded_device_exist;
extern uint8_t xdata random_mac_addr[6];
extern bit pairing_failed;
extern bit identification_event;
extern bit Scan_Requset_flag;
extern uint8_t xdata master_mac_addr[6];
extern uint8_t xdata RSP_PAIRING_REQUEST_TABLE[11];
extern bit passkey_only_flag;
/*********************************************************************
** Extern Function
*********************************************************************/
...
extern void Consumer_pairing_rule_select(uint8_t tmpstatus);
extern uint8_t BLE_GetIdentificationResult(void);
extern uint8_t RF_Get_Partial_InitRF_Result(void);
#endif
