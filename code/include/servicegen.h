...
#define SIZE_ATTRIBUTE_HIDS_BASE_                       7
  ...
  #endif
  #ifdef _PROFILE_HOGP_KEYBOARD_
  #define SIZE_ATTRIBUTE_HIDS_KEYBOARD_                   (7-3)
  #else
...
#define SIZE_ATTRIBUTE_HIDS_RPT_REF                     2
  ...
  #endif
#else
  #define SIZE_ATTRIBUTE_HIDS_BASE_                       0
  #define SIZE_ATTRIBUTE_HIDS_COMSUMER_                   0
  #define SIZE_ATTRIBUTE_HIDS_MOUSE_                      0
  #define SIZE_ATTRIBUTE_HIDS_KEYBOARD_                   0
  #define SIZE_ATTRIBUTE_HIDS_RPT_REF                     0
  #define SIZE_ATTRIBUTE_HIDS_BOOT_KB                     0
  #define SIZE_ATTRIBUTE_HIDS_BOOT_MS                     0
#endif
...
#ifdef _PROFILE_HOGP_MOUSE_
#define SIZE_OF_ATTRIBUTE_VALUE_MS                      84
#else
...
#ifdef _PROFILE_HOGP_COMSUMER_
#define SIZE_OF_ATTRIBUTE_VALUE_CS                      25
#else
...
#define SIZE_ATTRIBUTE_BOND_BAS                         1
...
//////////////////////////////TaoBao+WeChat+WeChatSimpleMode+6UUID+GLS///////////////////////////////////
#define _HOGP_HDL_OFFSET_BASE_       						0x34
...
#define _GLS_HDL_OFFSET_BASE_     						_HOGP_HDL_OFFSET_BASE_ + SIZE_ATTRIBUTE_HIDS	+	SIZE_ATTRIBUTE_TAOBAO + SIZE_ATTRIBUTE_WECHAT + SIZE_ATTRIBUTE_WECHAT_SIMPLE_MODE + SIZE_ATTRIBUTE_USER_DEFINE_01
//////////////////////////////TaoBao+WeChat+WeChatSimpleMode+6UUID+GLS///////////////////////////////////



#define SIZE_ATTRIBUTE_SERVER_BOND    (SIZE_ATTRIBUTE_BOND_BAS+SIZE_ATTRIBUTE_BOND_HIDS)                                 
#define SIZE_ATTRIBUTE_SERVER         52 + SIZE_ATTRIBUTE_HIDS + SIZE_ATTRIBUTE_TAOBAO + SIZE_ATTRIBUTE_WECHAT + SIZE_ATTRIBUTE_WECHAT_SIMPLE_MODE + SIZE_ATTRIBUTE_USER_DEFINE_01 + SIZE_ATTRIBUTE_GLS


//#define SIZE_ATTRIBUTE_SERVER_BOND    1  
//#define SIZE_ATTRIBUTE_SERVER         48
/*********************************************************************
** Extern Code
*********************************************************************/
