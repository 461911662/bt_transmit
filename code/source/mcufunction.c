...
******************************************************************************
*1.åˆå§‹åŒ–P05 P06 P07 P32 P33æŒ‰é”®
*2.åˆå§‹åŒ–ä¸²å£å¼•è„š P30 P31
*3.åˆå§‹åŒ–ç³»ç»Ÿæ—¶é’Ÿï¼Œä½¿èƒ½å¼•è„šåŠŸèƒ½
*4.æ¸…é™¤RSFLAGå¯„å­˜å™¨æ ‡å¿—
*********************************************************************/
void InitMCU(void)
{
/*
...
*/
 ...
 //   P0WUN = 0xFF;
    ...
    /*********************************************/
    RSFLAG = 0x07; /* æ¸…é™¤LVDF,RESETNF,PORFé‡å¯æ ‡å¿— */
    check_stable = 0x5AA5;
}
