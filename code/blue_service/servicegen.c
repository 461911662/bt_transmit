...
const uint8_t code ADV_DATA_INITIAL[32] = 
{
    ...
    0x02,   /* AD type 广播出自己服务的UUID */
    0x01, 0x05, 0x03, 0x02, 0x12, 0x18, 0x03,
    0x19, 0xC0, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,
//    0x11, 0x18, 0x0f, 0x18, 0x10, 0x18, 0x05,
//    0x18, 0x16, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const uint8_t code SCAN_RESPONSE_DATA_INITIAL[32] = 
{
    ...
    0x0A, 0x08, 0x41, 0x4D, 0x49, 0x43, 0x43, 0x4F,
    0x4D, 0x2D, 0x46, 0x72, 0x61, 0x6E, 0x6B, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
*/
const uint8_t code SCAN_RESPONSE_DATA_INITIAL[32] = 
{
    0x09, /* AD type 广播出自己的蓝牙名字 */
	
//    0x08, 0x08, 0x4D, 0x6F, 0x4C, 0x69, 0x5F, 0x57,  //设备名称 MoLi_WX
    0x08, 0x08, 0x4B, 0x45, 0x59, 0x44, 0x5F, 0x57,  //设备名称 KEYD_WX
...
const uint8_t code ADV_DATA_INITIAL[32] = 
{
    ...
    0x02, 0x01, 0x06, 0x07, 0x03, 0xE7, 0xFE, 0x18,    //ADV Data
...
const uint8_t code SCAN_RESPONSE_DATA_INITIAL[32] = 
{
    ...
    0x09, 0x09, 0x4C, 0x53, 0x5F, 0x53, 0x43, 0x41,    //Scan Response Data
...
const uint8_t code ATT_HDL_GAP_DEVICE_NAME_INIT[] =
{
    ...
    0x2A, 0x00 ,
    7,
//    0x4D, 0x6F, 0x4C, 0x69, 0x5F, 0x57,  //设备名称 MoLi_WX
    0x4B, 0x45, 0x59, 0x44, 0x5F, 0x57,  //设备名称 KEYD_WX
    0x58,
};
...
////////////////////////WeChat//////////////////////////////////
    ...
    ATT_PERMISSION_PRIMARY_SERVICE,                                     //ATT_HDL_UDF01S_PRIMARY_SERVICE,
    ATT_PERMISSION_CHARACTERISTIC,                                      //ATT_HDL_UDF01S_CHARACTERISTIC_UDATR01,
    ATT_PERMISSION_HDL_WECHAT_DATW,                                  //ATT_HDL_UDF01S_UDATR01,
    ATT_PERMISSION_CHARACTERISTIC,                                      //ATT_HDL_UDF01S_CHARACTERISTIC_UDATN01,
    ATT_PERMISSION_HDL_WECHAT_DATI_INIT,                             //ATT_HDL_UDF01S_UDATN01_INIT,
    ATT_PERMISSION_HDL_WECHAT_DATI_CLIENT_CHARACTERISTIC_CONFIGURATION_INIT,
    ATT_PERMISSION_CHARACTERISTIC,                                      //ATT_HDL_UDF01S_CHARACTERISTIC_UDATR01,
    ATT_PERMISSION_HDL_WECHAT_DATR,                                  //ATT_HDL_UDF01S_UDATR01,
/////////////////////Simple mode current pedometer measurement//////////////////
#ifdef _PROFILE_WECHAT_SIMPLE_MODE_
    ATT_PERMISSION_CHARACTERISTIC,                                      //ATT_HDL_UDF01S_CHARACTERISTIC_UDATN01,
    ATT_PERMISSION_HDL_WECHAT_SIMPLEMODE_DATRI_INIT,                             //ATT_HDL_UDF01S_UDATN01_INIT,
    ATT_PERMISSION_HDL_WECHAT_SIMPLEMODE_DATRI_CLIENT_CHARACTERISTIC_CONFIGURATION_INIT,
/////////////////////Simple mode current pedometer measurement//////////////////
/////////////////////Simple mode target/////////////////////////////////////////
    ATT_PERMISSION_CHARACTERISTIC,                                      //ATT_HDL_UDF01S_CHARACTERISTIC_UDATN01,
    ATT_PERMISSION_HDL_WECHAT_SIMPLEMODE_DATRWI_INIT,                             //ATT_HDL_UDF01S_UDATN01_INIT,
