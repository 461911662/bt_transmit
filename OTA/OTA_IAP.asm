...
; *************************************************************************************************
#define BATTERY_DETECT_COUNT    20000  /* echo battery detect use 100us, 2000000us/100us = 20000 */
; *************************************************************************************************
...
F_BatteryDetect:
        ...
        movx    @DPTR, a        ; [0x2038] = 0x90
F_BatteryDetect_Retry:
        mov     DPTR, #0x202B   ; Battery detect Register
        mov     a, #0x24
        movx    @DPTR, a        ; [0x202B] = 0
        ...
        call    F_delay_100us
        movx    a, @DPTR
        jb      acc.0, F_BatteryDetect_Retry    ; BDS=0, try again
...
//-----------------------------------------------------------------------------
//      call = 4C
//  4+2+n*(5+1+1)+4 = 10+7*n
//  100us = 1600 --> n = (1600-10)/7=227
; *************************************************************************************************
F_delay_100us:
        mov     R4, #227                    ; 2C
    _F_delay_100us_loop:
        nop                                 ; 1C
        nop                                 ; 1C
        djnz    R4, _F_delay_100us_loop     ; 5C
        ret                                 ; 4C
; *************************************************************************************************
